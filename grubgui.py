...
class BareboneBuilder:
    ...
    def new_file(self):
        ...
        if 0==0:
            ...
            self.execute_command("cp /boot/grub/i386-pc/vga.mod ./file/isodir/boot/grub/i386-pc",True)
            self.execute_command("cp /boot/grub/i386-pc/video.mod ./file/isodir/boot/grub/i386-pc",True)
            self.execute_command("cp /boot/grub/i386-pc/jpeg.mod ./file/isodir/boot/grub/i386-pc",True)
            self.execute_command("cp /boot/grub/i386-pc/gfxterm.mod ./file/isodir/boot/grub/i386-pc",True)
